...
import UserHeader from './components/7_FinalUserHeader';
import {FinalUserContextConsumer} from './components/context/7_finalUserContext';

class FinalUserApp extends React.Component {
    state={
        newUsername: ""
    }
    handleChange = (e) => {
