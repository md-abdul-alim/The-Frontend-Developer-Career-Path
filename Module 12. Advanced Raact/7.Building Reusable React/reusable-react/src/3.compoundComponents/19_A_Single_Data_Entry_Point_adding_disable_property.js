...
function App() {
  ...
  return (
    <div className="App">
      <Accordion data={data} disabled={[1]}/>{/*position="bottom" we can remove position bottom to bring the paragraph under title */}
    </div>
  )
}
...
ReactDOM.render(<App />, document.getElementById('aSingleDataEntryPointAddingDisableProperty'));